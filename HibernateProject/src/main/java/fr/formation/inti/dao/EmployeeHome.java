...
// Generated 18 janv. 2022 � 15:51:09 by Hibernate Tools 4.3.5.Final
 ...
 * @see fr.formation.inti.dao.Employee
...
public class EmployeeHome {
	...
	public Employee findById(java.lang.Integer id) {
		...
		try {
			Employee instance = (Employee) sessionFactory.getCurrentSession().get("fr.formation.inti.dao.Employee", id);
			if (instance == null) {
	...
	public List<Employee> findByExample(Employee instance) {
		...
		try {
			List<Employee> results = (List<Employee>) sessionFactory.getCurrentSession()
					.createCriteria("fr.formation.inti.dao.Employee").add(create(instance)).list();
