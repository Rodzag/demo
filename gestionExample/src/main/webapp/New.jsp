			...
			<div class="row">
				<div class="col-xl-9 mx-auto">
					<div class="cta-inner bg-faded text-center rounded">
						...
						<form action="/gestionExample/new" method="post">

							<label for="login">Prenom :</label><br> 
							<input type="text" style="text-align: center" id="firstName" name="firstName"><br> 
							
							<label for="passWord">Nom :</label><br>
							<input type="text" id="lastName" name="lastName" style="text-align: center"><br>
